...
* Stores information as **binary data** (binary representation)
...
* **Primary storage**
  - Processor **cache** is an intermediate stage between ultra-fast processor registers and much slower main memory 
